...
# DON'T GET ATTACHED TO THIS. IT WILL MOVE. IT WILL BE MADE ALL
# SMUSHED-UP-TOGETHER WITH THE RSS STUFF AND PUT IN A LIBRARY
# AND ALL THAT GOOD STUFF (20150825/straup)
...
class TinyLetter:
    ...
    def as_text(self, fh):
        ...
        kwargs = { 'entextify': True, 'max_items': 1 }
